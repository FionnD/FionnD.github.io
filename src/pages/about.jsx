...
export default function About() {
  return (
    <>
      <Head>
        <title>About - Fionn Delhaunty</title>
        <meta
          name="description"
          content="I’m Fionn Delahunty. I live in Berlin, where I design the future."
        />
      </Head>
        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:order-first lg:row-span-2">
            <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
              ...
              Hey, I'm Fionn, nice to meet you
            </h1>
          ...
          <div className="lg:pl-20">
            <ul role="list">
              <SocialLink href="https://twitter.com/f_delahunty" icon={TwitterIcon}>
                Follow on Twitter
              </SocialLink>
              <SocialLink href="https://github.com/FionnD" icon={GitHubIcon} className="mt-4">
                Follow on GitHub
              </SocialLink>
              <SocialLink href="https://www.linkedin.com/in/fionndelahunty/" icon={LinkedInIcon} className="mt-4">
                Follow on LinkedIn
              </SocialLink>
              <SocialLink
                href="mailto:Fionnd@pm.me"
                icon={MailIcon}
